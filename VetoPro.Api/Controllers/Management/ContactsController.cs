...
namespace VetoPro.Api.Controllers.Management;
    ...
    : BaseApiController(context)
{
    ...
    {
        var validationResult = await contactCreateValidator.ValidateAsync(createDto);
    ...
    {
        var validationResult = await contactUpdateValidator.ValidateAsync(updateDto);
        if (!validationResult.IsValid)
        {
            return ValidationProblem(new ValidationProblemDetails(validationResult.ToDictionary()));
        }
        ...
        {
            var staffDto = updateDto.StaffDetails!;
            ...
            else
            {
                ...
                contactToUpdate.StaffDetails.Role = staffDto.Role;
                contactToUpdate.StaffDetails.LicenseNumber = staffDto.LicenseNumber;
                contactToUpdate.StaffDetails.Specialty = staffDto.Specialty;
                contactToUpdate.StaffDetails.IsActive = staffDto.IsActive;
            }
        }
